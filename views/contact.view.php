                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/contact.php" class="bg-gray-900 text-white block rounded-md text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
